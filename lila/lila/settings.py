"""
Django settings for lila project.
...
if "RU-lila\\writable" in WRITABLE_DIR:
    ...
    WRITABLE_DIR = os.path.abspath(os.path.join(BASE_DIR, "../../writable/lila/database/"))
...
# MIDDLEWARE_CLASSES = [
MIDDLEWARE = [
    'lila.utils.BlockedIpMiddleware',
...
WSGI_APPLICATION = 'lila.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(WRITABLE_DIR, 'lila.db'),
        'TEST': {
            'NAME': os.path.join(WRITABLE_DIR, 'lila-test.db'),
            }
    }
}
