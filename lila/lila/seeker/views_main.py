...
from lila.seeker.adaptations import listview_adaptations, add_codico_to_manuscript
        ...
        try:
            ...
            if not istemplate:
                ...
                mainitems_m2m = [
                    ...
                    # 'multiple': True,
                    # 'field_list': 'siglist_m', 'fso': self.formset_objects[4], 'template_selection': 'ru.lila.sigs_template'},
                    {'type': 'plain',   'label': "Personal datasets:",  'value': instance.get_collections_markdown(username, team_group, settype="pd"), 
...
class CanwitListView(BasicList):
    ...
    filters = [ {"name": "Author",           "id": "filter_author",         "enabled": False},
                ...
                {"name": "Status",           "id": "filter_stype",          "enabled": False},
                {"name": "lila code",        "id": "filter_lilacode",       "enabled": False},
        ...
        try:
            ...
            context['mainitems'] = [
                ...
                {'type': 'line', 'label': "Literature:",            'value': instance.get_litrefs_markdown(), 
                 ...
                 'multiple': True, 'field_list': 'litlist', 'fso': self.formset_objects[2], 'template_selection': 'ru.lila.litref_template'},
