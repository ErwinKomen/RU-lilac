...
urlpatterns = [
    ...
    url(r'^api/srmincipits/$', lila.seeker.views_ta.get_srmincipits, name='api_srmincipits'),
    url(r'^api/srmexplicits/$', lila.seeker.views_ta.get_srmexplicits, name='api_srmexplicits'),
